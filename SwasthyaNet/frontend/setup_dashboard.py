...
with open(os.path.join(src_dir, "pages", "DistrictAdminDashboard.jsx"), "w") as f:
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-slate-200">
              ...
              <tbody className="bg-white divide-y divide-slate-200">
                {centres.map((centre) => (
                  <tr key={centre.centre_id} className="hover:bg-slate-50 transition">
...
print("Updated DistrictAdminDashboard.jsx")
